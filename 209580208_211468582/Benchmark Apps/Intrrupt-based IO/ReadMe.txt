...
On every BT interrupt-interval of 1sec (value of 0x01312D00 is for SMCLK=20MHz):
-------------------------------------------------------------------------------
a0=a0+1
========================================================================================
...
On RESET:
--------
*)Set the interrupt-interval to 1sec(value of 0x01312D00 is for SMCLK=20MHz)
*)The FSM's state0 is chosen 
	

On KEY1 pushing:
---------------
*)Set the interrupt-interval to 0.5sec(value of 0x01312D00/2 is for SMCLK=20MHz)
*)The FSM's state1 is chosen:
	print onto HEX1,HEX0 the value of a0
...
On KEY2 pushing:
---------------
*)Set the interrupt-interval to 0.25sec(value of 0x01312D00/4 is for SMCLK=20MHz)
*)The FSM's state2 is chosen:
	print onto HEX3,HEX2 the value of a0
	print onto LEDRs[7-0] the value of a0
*)goto idle state 
...
On KEY3 pushing:
---------------
*)Set the interrupt-interval to 0.125sec(value of 0x01312D00/8 is for SMCLK=20MHz)
*)The FSM's state3 is chosen:
	print onto HEX5,HEX4 the value of a0
	print onto LEDRs[7-0] the value of a0
*)goto idle state 
