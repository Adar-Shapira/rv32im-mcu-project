...
#   than clk_i itself, and with GEN_RESET_ON_LOCK the core does not leave reset
#   until that PLL reports lock. tools/check_staging.py now asserts this on
#   every whole-MCU vsim line.
