...
echo ""
echo "One note is EXPECTED and is not a failure: RV32IMscMCU reports once that an"
echo "SFR access reached the bus interface while Phase 5B has no peripherals, so"
echo "the write was discarded. Phase 6 replaces that stub with the real GPIO."
