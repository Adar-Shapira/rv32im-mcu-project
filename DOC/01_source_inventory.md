...
| **Hanan Ribo — added 2026-08-25** | `Auxiliary/מבנה הצגה ובדיקת פרויקט מסכם.md` (the project inspection/presentation protocol), `Auxiliary/hanan/` (50 lecture-note files: the full course material — VHDL, pipeline, verification, the lab syllabus) | Course-official material. **The protocol file is a garbled PDF extraction** — Hebrew stored character-reversed with scrambled column order; it was decoded by per-line reversal and the reconstruction lives in `DOC/04` §9 ("the demo-day protocol"). The six-level table's *existence* and level 1/level 6 endpoints are certain; the exact feature list of levels 2–5 could not be fully recovered from the scramble and is marked accordingly. |
